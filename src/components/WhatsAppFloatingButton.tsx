...
export default function WhatsAppFloatingButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-black shadow-lg shadow-black/40 transition-transform hover:scale-105 sm:bottom-6 sm:right-6"
    >
