...
const CHECKLIST = [
  "Custom ERP, CRM & POS Solutions",
  "Windows, macOS & Linux Applications",
  "Secure, Fast & Scalable Software",
  "Business Automation & Ongoing Support",
];

export default function DesktopSoftwareHero() {
  return (
    <section id="desktop-software-hero" className="relative overflow-hidden">
      ...
      <div className="section relative z-10 grid items-center gap-12 pb-10 pt-8 lg:grid-cols-[1.05fr_1fr] lg:gap-10 lg:pt-12">
        <div className="text-center lg:text-left">
          ...
          <h1 className="mx-auto mt-4 max-w-xl font-display text-3xl font-semibold leading-[1.15] sm:text-4xl lg:mx-0 lg:text-5xl">
            <span className="text-white">Desktop App Design</span>
            <br />
          ...
          <p className="mx-auto mt-5 max-w-xl text-sm font-semibold tracking-wide text-white/80 sm:text-base lg:mx-0">
            Powerful Desktop Applications for Modern Businesses
          </p>
          ...
          <p className="mx-auto mt-4 max-w-lg text-sm leading-relaxed text-muted lg:mx-0">
            ...
            Windows, macOS, and Linux that improve efficiency and support
            business growth.
          </p>
