  ...
  return (
    ...
    >
      <div className="absolute inset-0 -z-10">
        <Image
          src="/graphic-design/hero-glow.png"
          alt="Glowing digital globe surrounded by icons for code, mobile, cloud, security, analytics, and support, representing FAAH Technology's graphic design services"
          fill
      ...
      <div className="section relative w-full">
        <div className="max-w-xl text-center lg:text-left">
          ...
          <h1 className="mx-auto mt-4 max-w-xl font-display text-3xl font-semibold leading-[1.15] sm:text-4xl lg:mx-0 lg:text-5xl">
            ...
            <br />
            <span className="text-gold tracking-tight">Make an Impact</span>
          </h1>

          <p className="mx-auto mt-5 max-w-xl text-sm font-semibold tracking-wide text-white/80 sm:text-base lg:mx-0">
            Creative. Bold. On-Brand.
          </p>

          <p className="mx-auto mt-4 max-w-lg text-sm leading-relaxed text-white/60 lg:mx-0">
            From logos to full brand identities, we create visuals that
            help your business stand out and stay memorable.
          </p>
